...
description: Use when creating, converting, or improving HTML slide decks where layout, motion, viewport fit, and visual direction matter.
---
...
2. Generate **3 single-slide preview files** in `.plans/slide-previews/`.
...
1. Prefer `uv` with `python-pptx` to extract text, images, and notes.
